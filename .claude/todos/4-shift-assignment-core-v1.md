...
- [x] **T3. H-3（1 人 1 枠まで）を明示的に検証するテストを追加する**
  - 依頼事項：
...
- [x] **T6. 同点時の決定方法を検証するテストを追加する（H-3 ではなく仕様 5.3 節）**
  - 依頼事項：
