...
class DailyShiftResultTest {
  ...
  @Test
  @DisplayName("割り当て結果ありの DailyShiftResult を作成できる")
  void testCreateWithAssignment() {
  ...
  @Test
  @DisplayName("割り当て結果なし（不成立）の DailyShiftResult を作成できる")
  void testCreateWithoutAssignment() {
    LocalDate date = LocalDate.of(2024, 9, 2);
